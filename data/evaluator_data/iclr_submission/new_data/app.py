...
if __name__ == "__main__":
    # Auto-detect data file location (for different deployment scenarios)
    possible_paths = [
        "final_dataset.jsonl",  # Same directory (Hugging Face Spaces)
        "./final_dataset.jsonl",  # Explicit relative path
        "/home/ubuntu/wenjie-cal/ProofGym/evaluator_design/data/iclr_submission/new_data/final_dataset.jsonl",  # Full path
    ]
    ...
    if data_file is None:
        raise FileNotFoundError("Could not find final_dataset.jsonl. Please ensure it's in the same directory as app.py")
